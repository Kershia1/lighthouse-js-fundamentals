...
Range: array of two numbers representing the start and end values for the loop
Multiples: array of two numbers representing the multiples you want to replace with words
...
Desired Output:
loopyLighthouse function log to the console all the numbers from 15 to 90, except replacing multiples of 2 with "Batty", multiples of 5 with "Beacon", and multiples of 2 and 5 with "BattyBeacon"
